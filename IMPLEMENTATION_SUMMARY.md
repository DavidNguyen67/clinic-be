...
Updated `DoctorServiceImp.java` to delegate to clinicService methods
...
1. `src/main/java/com/camel/clinic/clinicService/doctor/DoctorService.java`
2. `src/main/java/com/camel/clinic/clinicService/doctor/DoctorServiceImp.java`
3. `src/main/java/com/camel/clinic/clinicService/doctor/DoctorServiceInv.java`
