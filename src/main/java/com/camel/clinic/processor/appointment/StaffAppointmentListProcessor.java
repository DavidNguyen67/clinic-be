...
@Component("staffAppointmentListProcessor")
@RequiredArgsConstructor
public class StaffAppointmentListProcessor implements Processor {
    ...
    public void process(Exchange exchange) {
        ...
        exchange.getMessage().setBody(appointmentServiceImp.getStaffAppointments(queryParams));
    }
}
