...
@Component("appointmentNextProcessor")
@AllArgsConstructor
@Slf4j
public class AppointmentNextProcessor implements Processor {
    ...
    public void process(Exchange exchange) {
        ...
        ResponseEntity<?> response = serviceImp.retrieveNext(queryParams);
