...
@Component("appointmentTodayProcessor")
@RequiredArgsConstructor
public class AppointmentTodayProcessor implements Processor {

    private final AppointmentServiceImp appointmentServiceImp;

    @Override
    public void process(Exchange exchange) {
        exchange.getMessage().setBody(appointmentServiceImp.getTodayAppointments());
    }
}
