...
@Component("appointmentStartProcessor")
@RequiredArgsConstructor
public class AppointmentStartProcessor implements Processor {
    ...
    public void process(Exchange exchange) {
        ...
        exchange.getMessage().setBody(appointmentServiceImp.startAppointment(id));
    }
}
